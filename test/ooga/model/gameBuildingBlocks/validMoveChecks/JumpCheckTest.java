...
public class JumpCheckTest {
  ...
  void JumpCheckTest() {
    ...
    ValidMoveCheck jumpCheck = new JumpCheck();
    assertTrue(jumpCheck.isValidMove(boardStructure,2,0,0,2));
  }

  @Test
  void JumpSameTeamCheckTest() {
    BoardStructure boardStructure = new BoardStructure(createPieceBoardStructure(3, List.of(
        "Empty", "Empty", "Empty",
    ...
    ValidMoveCheck jumpCheck = new JumpCheck();
    assertTrue(!jumpCheck.isValidMove(boardStructure,0,0,0,0));
  }


  @Test
  void NoJumpCheckTest() {
    BoardStructure boardStructure = new BoardStructure(createPieceBoardStructure(3, List.of(
