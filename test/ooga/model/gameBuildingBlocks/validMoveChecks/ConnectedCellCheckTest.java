...
public class ConnectedCellCheckTest {
  @Test
  void ConnectedCellCheckTest() {
    ...
    ValidMoveCheck connectedCell = new ConnectedCellCheck();
    assertTrue(connectedCell.isValidMove(boardStructure,0,0,1,1));
  }

  @Test
  void NotConnectedCellCheckTest() {
    BoardStructure boardStructure = new BoardStructure(createPieceBoardStructure(3, List.of(
        "Empty", "Empty", "Empty",
        "Empty", "Empty", "Empty",
        "NormalPiece 1", "NormalPiece 1", "NormalPiece 1"
    ...
    ValidMoveCheck connectedCell = new ConnectedCellCheck();
    assertTrue(!connectedCell.isValidMove(boardStructure,0,0,0,1));
  }


  @Test
  void ConnectedCellDiagonalPieceCheckTest() {
    BoardStructure boardStructure = new BoardStructure(createPieceBoardStructure(3, List.of(
        "Empty", "Empty", "Empty",
        "Empty", "Empty", "Empty",
