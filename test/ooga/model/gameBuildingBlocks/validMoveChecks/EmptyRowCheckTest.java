...
public class EmptyRowCheckTest {
  @Test
  void EmptyRowCheckTest() {
  ...
  @Test
  void VaryingTeamNonEmptyRowCheckTest() {
    BoardStructure boardStructure = new BoardStructure(createPieceBoardStructure(3, List.of(
        "SpecialPiece 2", "Empty", "Empty",
        "NormalPiece 2", "SpecialPiece 2", "SpecialPiece 1",
        "SpecialPiece 1", "Empty", "NormalPiece 1"
    )));
    ValidMoveCheck emptyCellCheck = new EmptyCellCheck();
    assertTrue(!emptyCellCheck.isValidMove(boardStructure,0,0,1,2));
  }
