...
public class OutflankDiagonalDownCheckTest {
  @Test
  void OutflankDiagonalDownTest() {
    ...
    ValidMoveCheck outflankDiagonalDownCheck = new OutflankDiagonalDownCheck(1);
    assertTrue(outflankDiagonalDownCheck.isValidMove(boardStructure,0,0,0,0));
  }
