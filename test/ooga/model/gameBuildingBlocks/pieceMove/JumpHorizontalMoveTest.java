...
public class JumpHorizontalMoveTest {
  @Test
  void JumpHorizontalMoveTeam1Test() {
    BoardStructure boardStructure = new BoardStructure(createPieceBoardStructure(3, List.of(
        "Empty", "Empty", "Empty",
        "Empty", "NormalPiece 2", "NormalPiece 1",
        "Empty", "Empty", "Empty"
    )));
    PieceMove pieceMove = new JumpHorizontalMove();
    List<PossibleMove> validMoves = pieceMove.getValidMoves(boardStructure,1,2,1);
  ...
  void JumpHorizontalMoveTeam2Test() {
    BoardStructure boardStructure = new BoardStructure(createPieceBoardStructure(3, List.of(
        "Empty", "Empty", "Empty",
        "NormalPiece 2", "NormalPiece 1", "Empty",
        "Empty", "Empty", "Empty"
    )));
    PieceMove pieceMove = new JumpHorizontalMove();
    List<PossibleMove> validMoves = pieceMove.getValidMoves(boardStructure,1,0,2);
  ...
  void NoJumpHorizontalMoveSameTeamTest() {
    BoardStructure boardStructure = new BoardStructure(createPieceBoardStructure(3, List.of(
        "Empty", "Empty", "Empty",
        "Empty", "NormalPiece 1", "NormalPiece 1",
        "Empty", "Empty", "Empty"
    )));
    PieceMove pieceMove = new JumpHorizontalMove();
    List<PossibleMove> validMoves = pieceMove.getValidMoves(boardStructure,1,2,1);
