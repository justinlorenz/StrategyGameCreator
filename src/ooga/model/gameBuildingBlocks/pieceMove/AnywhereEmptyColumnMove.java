...
import ooga.model.gameBuildingBlocks.validMoveChecks.EmptyColumnCheck;
 ...
 */
public class AnywhereEmptyColumnMove extends PieceMove {
  ...
  public List<PossibleMove> getValidMoves(BoardStructure currBoard, int pieceI, int pieceJ,
    ...
    List<ValidMoveCheck> validMoveChecks = List.of(new EmptyColumnCheck());
