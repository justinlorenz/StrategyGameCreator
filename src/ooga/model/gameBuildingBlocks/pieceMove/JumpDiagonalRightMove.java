 ...
 * to the right in the players direction.

 */
public class JumpDiagonalRightMove extends PieceMove {
  ...
  public List<PossibleMove> getValidMoves(BoardStructure currBoard, int pieceI, int pieceJ,
    ...
    for (int direction : directionList) {
      PossibleMove move = new PossibleMove(pieceI + direction * 2, pieceJ + 2);
    ...
    //FIXME: Order of checks matters!
    return possibleMoves;
    // EmptyCellCheck,OutOfBoundsCheck,JumpCheck
  }
}
