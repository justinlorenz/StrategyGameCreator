...
/**
 * PieceMove building block which gets all moves that allow piece to go horizontally.
 *
 * @author Loten Lhatsang
 * @author Justin Lorenz
 * @author Jerry Fang
 */
public class HorizontalMove extends PieceMove {
  ...
  public List<PossibleMove> getValidMoves(BoardStructure currBoard, int pieceI, int pieceJ,
    ...
    for (int direction : directionList) {
      PossibleMove move = new PossibleMove(pieceI, pieceJ + direction);
