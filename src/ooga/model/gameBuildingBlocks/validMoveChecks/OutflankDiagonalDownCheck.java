 ...
 * made outflanks an opponent piece Diagonally Downwards
 */
public class OutflankDiagonalDownCheck implements ValidMoveCheck {

  int playerNumber;

  public OutflankDiagonalDownCheck(int playerNumber) {
  ...
  /**
   * Checks if piece is outflanked Diagonally Upwards
   *
   ...
   */
  public boolean isOutflankedDiagonalUp(BoardStructure currBoard, int pieceI, int pieceJ,
      int destinationI, int destinationJ) {
    return ((transverseDiagonal(currBoard, destinationI, destinationJ, POSITIVE_DIRECTION,
        POSITIVE_DIRECTION) &&
        transverseDiagonal(currBoard, destinationI, destinationJ, NEGATIVE_DIRECTION,
